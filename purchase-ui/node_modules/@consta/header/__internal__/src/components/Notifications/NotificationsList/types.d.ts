...
export type NotificationsListPropGetItemBadges<ITEM> = (item: ITEM) => NotificationsItemBadge[] | undefined;
export type NotificationsListPropGetItemActions<ITEM> = (item: ITEM) => NotificationsItemAction[] | undefined;
...
export type Props<ITEM, GROUP, ACTION, GROUP_BY_DAY extends boolean> = {
    ...
    label: NotificationsItemAction['label'];
} ? {} : {
    getActionLabel: NotificationsListPropGetItemActions<ACTION>;
}) & (GROUP extends {
    label: NotificationsListDefaultGroup['label'];
} ? {} : {
    getGroupLabel: NotificationsListPropGetGroupLabel<GROUP>;
}) & (GROUP extends {
    id: NotificationsListDefaultGroup['id'];
} ? {} : {
    getGroupId: NotificationsListPropGetGroupId<GROUP>;
}) & (ITEM extends {
    label: NotificationsListDefaultItem['label'];
} ? {} : {
    getItemLabel: NotificationsListPropGetItemLabel<ITEM>;
});
...
export type NotificationsListComponent = <ITEM = NotificationsListDefaultItem, GROUP = NotificationsListDefaultGroup, ACTION = NotificationsItemAction, GROUP_BY_DAY extends boolean = false>(props: NotificationsListProps<ITEM, GROUP, ACTION, GROUP_BY_DAY>) => React.ReactElement | null;
