...
export type TileMenuListPropGetItemImage<ITEM> = (item: ITEM) => string | React.FC | undefined;
...
export type TileMenuListProps<ITEM = TileMenuListDefaultItem> = PropsWithHTMLAttributesAndRef<TileMenuListCommonProps<ITEM>, HTMLDivElement> & TileMenuListCommonProps<ITEM> & (ITEM extends {
